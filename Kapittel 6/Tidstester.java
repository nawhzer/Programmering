...
public class Tidstester
{
  public static void main( String[] args )
  {
    ...
    {
      String timetall =
          JOptionPane.showInputDialog( "Skriv antall timer (heltall):" );
      String minuttall =
          JOptionPane.showInputDialog( "Skriv antall minutter (heltall):" );
      String sekundtall =
          JOptionPane.showInputDialog( "Skriv antall sekunder (heltall):" );
      ...
      String utskrift = timetall + " timer, " + minuttall + " minutter, " +
          sekundtall + " sekunder = " + sekunder + " sekunder.";
      JOptionPane.showMessageDialog( null, utskrift,
                                     "Beregning av tid i sekunder",
